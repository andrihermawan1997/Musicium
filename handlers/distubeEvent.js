...
module.exports = (client) => {
  ...
  function receiveQueueData(newQueue, newTrack) {
    ...
    var embed = new MessageEmbed().setColor(ee.color)
      ...
      .addField(`♾ Loop:`, `>>> ${newQueue.repeatMode ? newQueue.repeatMode === 2 ? `<a:ndyes:879927260537315328>\` Queue\`` : `<a:ndloop:906783138410274858> \`Song\`` : `${client.allEmojis.x}`}`, true)
      .addField(`↪️ Autoplay:`, `>>> ${newQueue.autoplay ? `<a:ndyes:879927260537315328>` : `<a:ndloop:906783138410274858>`}`, true)
